  ...
  <div id="user-manage-page">
    ...
    >
      ...
      >
        ...
        <a-form-item
          label="客户名Firstname"
          :rules="[{ required: false, message: '请输入客户名!' }]"
        >
        ...
        <a-form-item
          label="客户姓Lastname"
          :rules="[{ required: false, message: '请输入客户姓!' }]"
        >
        ...
        <a-form-item
          label="电话号"
          :rules="[{ required: false, message: '请输入客户联系电话!' }]"
        >
        ...
        <a-form-item
          label="email"
          :rules="[{ required: false, message: '请输入客户email!' }]"
        >
...
import { searchUsers, deleteUsers, editUsers, addUsers } from "@/api/user";
...
const columns = [
  ...
  { title: "用户姓", dataIndex: "last_name" },
  { title: "用户名", dataIndex: "first_name" },
